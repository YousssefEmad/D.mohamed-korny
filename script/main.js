...
let scroll_bottom =document.querySelector(".scroll_bottom")
...
if(this.scrollY <= 0){
    scroll_bottom.classList.add("move");
} else {
    scroll_bottom.classList.remove('move');
}
}
...
window.scrollTo({
  ...
  $(document).ready(function() {
            $('.service_slider_wrapper_2 .owl-carousel').owlCarousel({
              loop: true,
              margin: 10,
              autoplay:false,
              smartSpeed: 1200,
